		...
		<table class="shop_table my_account_bookings">
			<thead>
				<tr>
					...
					<th scope="col" class="booking-cancel">Support</th>
				</tr>
			</thead>
			<tbody>
				<?php foreach ( $table['bookings'] as $booking ) : ?>
					...
					<tr>
						...
						<td class="order-number">
							<?php if ( $booking->get_order() ) : ?>
							<a href="<?php echo esc_html( $booking->get_order()->get_order_number() ); ?>" class="woocommerce-button button wcfm-support-action">
								<?php _e( 'Support', 'wc-frontend-manager-ultimate' ) ?>
							</a>
							<?php endif; ?>
						</td>
					</tr>
