...
$opt_name = 'nls_admin_settings';  // YOU MUST CHANGE THIS.  DO NOT USE 'redux_demo' IN YOUR PROJECT!!!
...
$args = array(
	...
	'menu_title'                => esc_html__( 'Extra Settings', 'jasy-child' ),

	// The text to appear on the page title.
	'page_title'                => esc_html__( 'Admin Options', 'jasy-child' ),
...
$args['admin_bar_links'][] = array(
	'id'    => 'redux-docs',
	'href'  => '//devs.redux.io/',
	'title' => __( 'Documentation', 'jasy-child' ),
);

$args['admin_bar_links'][] = array(
	'id'    => 'redux-support',
	'href'  => '//github.com/ReduxFramework/redux-framework/issues',
	'title' => __( 'Support', 'jasy-child' ),
);

$args['admin_bar_links'][] = array(
	'id'    => 'redux-extensions',
	'href'  => 'redux.io/extensions',
	'title' => __( 'Extensions', 'jasy-child' ),
);
...
if ( ! isset( $args['global_variable'] ) || false !== $args['global_variable'] ) {
	...
	$args['intro_text'] = '<p>' . sprintf( esc_html__( 'Did you know that Redux sets a global variable for you? To access any of your saved options from within your code you can use your global variable: $%1$s', 'jasy-child' ), '<strong>' . $v . '</strong>' ) . '<p>';
} else {
	$args['intro_text'] = '<p>' . esc_html__( 'This text is displayed above the options panel. It isn\'t required, but more info is always better! The intro_text field accepts all HTML.', 'jasy-child' ) . '</p>';
}

// Add content after the form.
//$args['footer_text'] = '<p>' . esc_html__( 'This text is displayed below the options panel. It isn\'t required, but more info is always better! The footer_text field accepts all HTML.', 'jasy-child' ) . '</p>';
...
$help_tabs = array(
	array(
		'id'      => 'redux-help-tab-1',
		'title'   => esc_html__( 'Theme Information 1', 'jasy-child' ),
		'content' => '<p>' . esc_html__( 'This is the tab content, HTML is allowed.', 'jasy-child' ) . '</p>',
	),
	array(
		'id'      => 'redux-help-tab-2',
		'title'   => esc_html__( 'Theme Information 2', 'jasy-child' ),
		'content' => '<p>' . esc_html__( 'This is the tab content, HTML is allowed.', 'jasy-child' ) . '</p>',
	),
);
...
$content = '<p>' . esc_html__( 'This is the sidebar content, HTML is allowed.', 'jasy-child' ) . '</p>';
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Resouce Limit Settings', 'jasy-child' ),
		'id'               => 'basic',
		'desc'             => esc_html__( 'These are really basic fields!', 'jasy-child' ),
...
//START Text Box
//get current week hours and next week hours
$resouce_limit = get_option( 'resouce_limit' );
if( $resouce_limit != ''){ $resouce_limit = '<b>'. $resouce_limit . ' hrs </b>'; }

$resouce_limit_next_week = get_option( 'set_resouce_limit_next_week' );	
if( $resouce_limit_next_week != ''){ $resouce_limit_next_week = '<b>'. $resouce_limit_next_week . ' hrs </b>'; }
if( $resouce_limit_next_week == ''){ $resouce_limit_next_week = '<b>Not Set yet! </b>'; }


$info = 'It will restrict vendor to define hours for resouce. <br/>Current week limit: ' . $resouce_limit . ' and Next Week Limit is : '. $resouce_limit_next_week;

Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Resouce Limit Hours', 'jasy-child' ),
		//'desc'             => esc_html__( 'It will restrict vendor to define hours for resouce.', 'jasy-child' ) . '<a href="https://devs.redux.io/core-fields/text.html" target="_blank">https://devs.redux.io/core-fields/text.html</a>',
		'id'               => 'resouce-limit-text',
		'subsection'       => true,
		...
		'fields'           => array(
			array(
				'id'       => 'resouce-limit',
				'type'     => 'text',
				'title'    => esc_html__( 'Limit (Hours)', 'jasy-child' ),
				//'subtitle' => esc_html__( 'Subtitle', 'jasy-child' ),
				'desc'     => $info,
				'default'  => '40',
			),
		),
...
if ( class_exists( 'Redux_Pro' ) ) {
	Redux::set_section(
		$opt_name,
		array(
			'title' => esc_html__( 'Redux Pro Fields', 'jasy-child' ),
			'id'    => 'redux-pro-fields',
			'icon'  => 'el el-redux',
			'class' => 'pro_highlight',
			'desc'  => esc_html__( 'For full documentation on this field, visit: ', 'jasy-child' ) . '<a href="https://devs.redux.io/premium/" target="_blank">https://devs.redux.io/premium/</a>',
		)
	);
...
if ( file_exists( $dir . '/../README.md' ) ) {
	$section = array(
		'icon'   => 'el el-list-alt',
		'title'  => esc_html__( 'Documentation', 'jasy-child' ),
		'fields' => array(
			array(
...
Redux::set_section(
	...
	array(
		'icon'            => 'el el-list-alt',
		'title'           => esc_html__( 'Customizer Only', 'jasy-child' ),
		'desc'            => '<p class="description">' . esc_html__( 'This Section should be visible only in Customizer', 'jasy-child' ) . '</p>',
		'customizer_only' => true,
		'fields'          => array(
			array(
				'id'              => 'opt-customizer-only',
				'type'            => 'select',
				'title'           => esc_html__( 'Customizer Only Option', 'jasy-child' ),
				'subtitle'        => esc_html__( 'The subtitle is NOT visible in customizer', 'jasy-child' ),
				'desc'            => esc_html__( 'The field desc is NOT visible in customizer.', 'jasy-child' ),
				'customizer_only' => true,
				'options'         => array(
					'1' => esc_html__( 'Opt 1', 'jasy-child' ),
					'2' => esc_html__( 'Opt 2', 'jasy-child' ),
					'3' => esc_html__( 'Opt 3', 'jasy-child' ),
				),
				'default'         => '2',
			),
		),
...
if ( ! function_exists( 'dynamic_section' ) ) {
	...
	function dynamic_section( array $sections ): array {
		$sections[] = array(
			'title'  => esc_html__( 'Section via hook', 'jasy-child' ),
			'desc'   => '<p class="description">' . esc_html__( 'This is a section created by adding a filter to the sections array. Can be used by child themes to add/remove sections from the options.', 'jasy-child' ) . '</p>',
...
if ( ! function_exists( 'change_defaults' ) ) {
	...
	function change_defaults( array $defaults ): array {
		$defaults['str_replace'] = esc_html__( 'Testing filter hook!', 'jasy-child' );
